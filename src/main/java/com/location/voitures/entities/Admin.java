...
public class Admin implements Serializable {
    ...
    public Admin(String nom, String prenom, String email, String motDePasseHashed, String telephone) {
        this.nom = nom;
        this.prenom = prenom;
        this.email = email;
	...
	// Ajouter ou effacer un admin
	public void ajouter(){
		new AdminDAO().save(this);;
	}

	public void effacer(){
		new AdminDAO().delete(this);;
	}
